...
function navigateTo(pageId, pushToHistory = true) {
  ...
  switch(pageId) {
    case 'customer-home':
      pageTitleEl.innerText = "Gadget Store";
      renderCustomerProducts();
      break;
    case 'product-detail-page':
      pageTitleEl.innerText = "Detail Gadget";
      break;
    case 'cart-page':
    ...
    case 'admin-input-page':
      pageTitleEl.innerText = document.getElementById('input-prod-id').value ? "Edit Gadget" : "Input Gadget Baru";
      break;
    case 'admin-products-page':
      pageTitleEl.innerText = "Kelola Produk Gadget";
      renderAdminProducts();
      break;
...
function confirmSheetAction() {
  ...
  if (sheetActionMode === 'add_to_cart') {
    ...
    updateCartBadge();
    showToast("Gadget berhasil ditambahkan ke keranjang!");
